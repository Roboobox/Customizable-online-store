    ...
    <div class="contact-form-container bg-white m-auto shadow-sm">
        <form action="" method="post" id="contactForm" novalidate>
            <div class="mb-3">
                ...
                <input type="email" value="<?=htmlspecialchars($_SESSION['user_data']['email'] ?? '')?>" class="form-control" id="email_input">
            ...
            <div class="contact-form-footer d-flex flex-column">
                ...
                <div class="other_options">
                    <?=isset($storeSettings['store_email']) ? '<div class="text-muted text-center"><i class="far fa-envelope align-middle"></i> <a class="text-muted" href="mailto: '.htmlspecialchars($storeSettings['store_email']).'">Send Email</a></div>' : ''?>
                    <?=isset($storeSettings['store_phonenr']) ? '<div class="text-muted text-center"><i class="fas fa-phone align-middle"></i> <a class="text-muted" href="tel: '.htmlspecialchars($storeSettings['store_phonenr']).'">'.htmlspecialchars($storeSettings['store_phonenr']).'</a></div>' : ''?>
                    <?=isset($storeSettings['store_address']) ? '<div class="text-muted text-center"><i class="fas fa-map-marker-alt align-middle"></i> '.htmlspecialchars($storeSettings['store_address']).'</div>' : ''?>
                </div>
            </div>
        </form>
    </div>
